    ...
    return (
        <li className="collection-item friend-requests-list valign-wrapper">
                        ...
                        <div className='accept-delete-btn'>
                            <a className="waves-effect waves-light green btn-small accept-btn">Accept</a>
                            <a className="waves-effect waves-light red btn-small delete-btn">Delete</a>
                        </div>
                    </li>
...
const FriendRequests = () => {
    ...
    useEffect(() => {
        ...
        var instances = M.Modal.init(modalRef, {})
    },[])
